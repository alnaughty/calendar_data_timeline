                    ...
                    children: [
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: FittedBox(
                            child: bodyTitleText(itemLabel??"", color: settings.topColor),
                          ),
                        ),
                      ),
                      Expanded(
                                  ...
                                  child: ListView(
                                      ...
                                      children: List.generate(
                                          snapshot.data!.daysInMonth,
                                              ...
                                              Container(
                                                decoration: BoxDecoration(
                                                    color: DateFormat.EEEE().format(DateTime(
                                                        snapshot.data!
                                                            .currentYear,
                                                        snapshot.data!
                                                            .currentMonth,
                                      ...
                                      children: List.generate(
                                          snapshot.data!.daysInMonth,
                                              ...
                                              Container(
                                                ...
                                                alignment:
                                                AlignmentDirectional.center,
                                                child: headerText((index+1).toString(), color: DateFormat.EEEE().format(DateTime(
                                                    snapshot.data!
                                                        .currentYear,
                                                    snapshot.data!
                                                        .currentMonth,
